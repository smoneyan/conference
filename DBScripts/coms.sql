...
--
-- Host: localhost
-- Generation Time: Nov 28, 2012 at 01:36 AM
...
INSERT INTO `conference` (`conf_id`, `title`, `description`, `price`, `location`, `conf_dt`, `submission_last_dt`, `review_last_dt`, `last_updated`, `conf_date`) VALUES
(1, 'conferene1', 'sfasf', 0, 'asdfasf', 123123, 123123, 123123, 1231230, 1231231),
(2, 'conference1', 'asfasdfa', 0, 'asdfasf', 123123123, 1231231, 123123123, 123123, 214748),
(3, 'conf1', 'sfsf', 0, 'sfsdfasf', 123123, 123123, 123123, 123123, 123123);
...
INSERT INTO `file` (`fid`, `uid`, `filename`, `uri`, `timestamp`, `filemime`) VALUES
(1, 1, 'file.jpeg', '/files/file.jpeg', 123123, 'image/jpeg');
...
INSERT INTO `item_status` (`status_id`, `name`) VALUES
(1, 'submitted'),
(2, 'completed'),
(3, 'approved');
...
CREATE TABLE IF NOT EXISTS `item_submission` (
  ...
  KEY `submitted_by` (`submitted_by`),
  KEY `fid` (`fid`),
  KEY `FK58E77BF8C836CA7` (`fid`),
  KEY `FK58E77BF8A7E503EE` (`schedule_id`),
  KEY `FK58E77BF8BCA53612` (`submitted_by`)
...
INSERT INTO `item_submission` (`item_id`, `schedule_id`, `title`, `submitted_by`, `description`, `fid`, `status`, `blind_review`, `contact_email`) VALUES
(2, 1, 'submission1', 1, 'sdfasdf', 1, 1, 1, 'smoneyan@gmail.com');
...
CREATE TABLE IF NOT EXISTS `schedule` (
  ...
  KEY `conf_id` (`conf_id`),
  KEY `type_id` (`type_id`),
  KEY `FKD6669297F89E76DC` (`conf_id`),
  KEY `FKD6669297D634E55` (`type_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=3 ;
...
INSERT INTO `schedule` (`schedule_id`, `title`, `conf_id`, `type_id`, `start_dt`, `end_dt`, `price`) VALUES
(1, 'schedule1', 1, 1, 123, 12312, 0);
...
--
ALTER TABLE `file`
  ADD CONSTRAINT `FK2FF57C36B4D847` FOREIGN KEY (`uid`) REFERENCES `user` (`uid`);
...
ALTER TABLE `item_submission`
  ADD CONSTRAINT `FK58E77BF8BCA53612` FOREIGN KEY (`submitted_by`) REFERENCES `user` (`uid`),
  ADD CONSTRAINT `FK58E77BF8A7E503EE` FOREIGN KEY (`schedule_id`) REFERENCES `schedule` (`schedule_id`),
  ADD CONSTRAINT `FK58E77BF8C836CA7` FOREIGN KEY (`fid`) REFERENCES `file` (`fid`),
...
ALTER TABLE `schedule`
  ADD CONSTRAINT `FKD6669297D634E55` FOREIGN KEY (`type_id`) REFERENCES `conf_item_type` (`type_id`),
  ADD CONSTRAINT `FKD6669297F89E76DC` FOREIGN KEY (`conf_id`) REFERENCES `conference` (`conf_id`),
